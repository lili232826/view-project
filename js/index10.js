                    ...
                    label: {
                        ...
                        position: ['2%', '-500%'],
												formatter: function (value) {
													...
													return (value.data/100*100).toFixed(1)+"%";
												},
                        textStyle: {
                            color: '#fff',
                            fontSize: '18'
...
var option1 = {
  ...
  var option2 = {
        ...
        // 使用刚指定的配置项和数据显示图表。
        qualityRatio0.setOption(option);
				qualityRatio1.setOption(option1);	
				qualityRatio2.setOption(option2);
